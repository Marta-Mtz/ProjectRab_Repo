...
<<<<<<< HEAD:ProjectRAB_Project/Assets/RAB_Root/Scripts/PlayerController2.cs
    public Vector2 moveInput; //Almac n del input de movimiento de los perif ricos que usamos para jugar
=======
    public Vector2 moveInput; //Almac�n del input de movimiento de los perif�ricos que usamos para jugar
>>>>>>> parent of 4115d6e (Arreglado el bug de la camara y los controles :)):ProjectRAB_Project/Assets/RAB_Root/Scripts/PlayerController.cs
